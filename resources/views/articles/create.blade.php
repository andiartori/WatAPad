...
<div class="max-w-2xl mx-auto mt-10">
    ...
    <form id="articleForm" action="/articles/create" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-4">
            ...
            <textarea name="overview" class="w-full border rounded px-3 py-2" required></textarea>
        </div>
        ...
        <div class="flex gap-2">
            ...
            <a href="/" class="px-4 py-2 rounded border hover:bg-gray-100">Batalkan</a>
        </div>
    </form>
